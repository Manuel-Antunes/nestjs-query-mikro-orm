...
describe('SQLComparisonBuilder', (): void => {
  const createSQLComparisonBuilder = () =>
  ...
  describe('eq comparisons', () => {
    it('should build eq filter', (): void => {
      expect(
        createSQLComparisonBuilder().build('stringType', 'eq', 'foo'),
      ).toEqual({
        stringType: { $eq: 'foo' },
      });
    });
  ...
  describe('neq comparisons', () => {
    it('should build neq filter', (): void => {
      expect(
        createSQLComparisonBuilder().build('numberType', 'neq', 1),
      ).toEqual({
        numberType: { $ne: 1 },
      });
    });
  ...
  describe('gte comparisons', () => {
    it('should build gte filter', (): void => {
      expect(
        createSQLComparisonBuilder().build('numberType', 'gte', 1),
      ).toEqual({
        numberType: { $gte: 1 },
      });
    });
  ...
  describe('lte comparisons', () => {
    it('should build lte filter', (): void => {
      expect(
        createSQLComparisonBuilder().build('numberType', 'lte', 1),
      ).toEqual({
        numberType: { $lte: 1 },
      });
    });
  ...
  describe('like comparisons', () => {
    it('should build like filter', (): void => {
      expect(
        createSQLComparisonBuilder().build('stringType', 'like', '%hello%'),
      ).toEqual({
  ...
  describe('notLike comparisons', () => {
    it('should build notLike filter', (): void => {
      expect(
        createSQLComparisonBuilder().build('stringType', 'notLike', '%hello%'),
      ).toEqual({
  ...
  describe('iLike comparisons', () => {
    it('should build iLike filter', (): void => {
      expect(
        createSQLComparisonBuilder().build('stringType', 'iLike', '%hello%'),
      ).toEqual({
  ...
  describe('notILike comparisons', () => {
    it('should build notILike filter', (): void => {
      expect(
        createSQLComparisonBuilder().build('stringType', 'notILike', '%hello%'),
      ).toEqual({
  ...
  describe('is comparisons', () => {
    it('should build is true filter', (): void => {
      expect(
        createSQLComparisonBuilder().build('boolType', 'is', true),
      ).toEqual({
        boolType: { $eq: true },
      });
    });
    ...
    it('should build is false filter', (): void => {
      expect(
        createSQLComparisonBuilder().build('boolType', 'is', false),
      ).toEqual({
        boolType: { $eq: false },
      });
    });
    ...
    it('should build is null filter', (): void => {
      expect(
        createSQLComparisonBuilder().build('boolType', 'is', null),
      ).toEqual({
        boolType: { $eq: null },
      });
    });
  ...
  describe('isNot comparisons', () => {
    it('should build isNot true filter', (): void => {
      expect(
        createSQLComparisonBuilder().build('boolType', 'isNot', true),
      ).toEqual({
        boolType: { $ne: true },
      });
    });
    ...
    it('should build isNot false filter', (): void => {
      expect(
        createSQLComparisonBuilder().build('boolType', 'isNot', false),
      ).toEqual({
        boolType: { $ne: false },
      });
    });
    ...
    it('should build isNot null filter', (): void => {
      expect(
        createSQLComparisonBuilder().build('boolType', 'isNot', null),
      ).toEqual({
        boolType: { $ne: null },
      });
    });
  ...
  describe('in comparisons', () => {
    it('should build in filter', (): void => {
      const arr = [1, 2, 3];
      expect(
        createSQLComparisonBuilder().build('numberType', 'in', arr),
      ).toEqual({
        numberType: { $in: arr },
      });
    });
    ...
    it('should throw an error for non-array', (): void => {
      expect(() =>
        createSQLComparisonBuilder().build('numberType', 'in', 1),
  ...
  describe('notIn comparisons', () => {
    it('should build notIn filter', (): void => {
      const arr = ['a', 'b', 'c'];
      expect(
        createSQLComparisonBuilder().build('stringType', 'notIn', arr),
      ).toEqual({
        stringType: { $nin: arr },
      });
    });
    ...
    it('should throw an error for empty array', (): void => {
      const arr: number[] = [];
      expect(() =>
        createSQLComparisonBuilder().build('numberType', 'notIn', arr),
      ).toThrow('Invalid in value expected a non-empty array got []');
    });

    it('should throw an error for non-array', (): void => {
      expect(() =>
        createSQLComparisonBuilder().build('numberType', 'notIn', 1),
      ).toThrow('Invalid in value expected an array got 1');
    });
  });
  ...
  describe('between comparisons', () => {
    it('should build between filter', (): void => {
      ...
      expect(
        createSQLComparisonBuilder().build('numberType', 'between', between),
      ).toEqual({
  ...
  describe('notBetween comparisons', () => {
    it('should build notBetween filter', (): void => {
      ...
      expect(
        createSQLComparisonBuilder().build('numberType', 'notBetween', between),
      ).toEqual({
